        ...
        <div className="flex items-start justify-between mb-8 flex-wrap gap-4">
          ...
          <div>
            ...
            <p className="text-ink-dim max-w-md">
              Step through the sort one comparison at a time,
              or press play and watch it run.
            </p>
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              ...
              onChange={(e) =>
                setAlgorithm(
                  e.target.value as AlgorithmKey
                )
              }
            ...
            >
              ...
              {(Object.keys(ALGORITHMS) as AlgorithmKey[]).map(
                (key) => (
